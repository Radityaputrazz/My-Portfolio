...
// Lazy load ParticlesContainer hanya di client & desktop
...
const Home = () => {
  return (
    <div className="relative h-screen bg-primary/60 overflow-hidden">
      ...
      {/* text & content */}
      <div className="relative z-10 flex flex-col justify-center h-full container mx-auto text-center xl:text-left xl:pt-40">
        <motion.h1
        ...
        >
          ...
          Into{" "}
          <span
            className="text-rose-600 drop-shadow-[0_2px_6px_rgba(0,0,0,0.9)] [text-shadow:1px_1px_3px_black]"
          >
            Full-Stack <br />
            Web Developer
          </span>
        ...
        >
          I craft modern and scalable web solutions, combining intuitive frontend interfaces with powerful backend architecture and reliable APIs to deliver exceptional digital experiences.
        </motion.p>
